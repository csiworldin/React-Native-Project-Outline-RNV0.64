...
export const ActionTypes = {
  ...
  SET_FIRST_TIME_ACCESS: "SET_FIRST_TIME_ACCESS",
...
function setFirstTimeAccess (data) {
  return { type: ActionTypes.SET_FIRST_TIME_ACCESS, data: data };
}
...
export const ActionCreators = {
  ...
  setFirstTimeAccess: setFirstTimeAccess,
