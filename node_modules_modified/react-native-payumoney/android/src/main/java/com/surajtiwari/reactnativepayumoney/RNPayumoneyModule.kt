        ...
        if (requestCode == PayUmoneyFlowManager.REQUEST_CODE_PAYMENT && resultCode == RESULT_OK && data != null) {
            ...
            if (transactionResponse != null && transactionResponse.getPayuResponse() != null) {
                ...
                if (transactionResponse.getTransactionStatus().equals(TransactionResponse.TransactionStatus.SUCCESSFUL)) {
                    sendEvent(PAYU_PAYMENT_SUCCESS, "{\"success\":true,\"response\":$payuResponse}")
                } else {
                    sendEvent(PAYU_PAYMENT_FAILED, "{\"success\":false,\"response\":$payuResponse}")
                }
            } else {
                sendEvent(PAYU_PAYMENT_FAILED, "{\"success\":false,\"message\":\"Some issue has occurred. Please try again later\"}")
            }
        }else{
            sendEvent(PAYU_PAYMENT_FAILED, "{\"success\":false,\"message\":\"Either the user has cancelled the payment or some issue has occurred. Please try again later\"}")
        }
    }
